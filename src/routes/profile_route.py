...
async def create_profile(profile: ProfileBase ,service: ProfileService = Depends(get_profile_service)):
...
async def update_profile(id: str, profile: ProfileBase, service: ProfileService = Depends(get_profile_service)):
