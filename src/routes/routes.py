...
from src.routes import home_route, experience_route, card_category_route, card_route, profile_route, social_link_route, auth_route
...
app_routes.include_router(auth_route.route)